...
def build_index(username: str, dataset: str, n_centroid: int, pq_n_partition: int, pq_n_bit_per_partition: int):
    ...
    index_path = f'/home/{username}/Dataset/vector-set-similarity-search/Index/{dataset}/emvb'
    ...
    query_text_fname = f'/home/{username}/Dataset/vector-set-similarity-search/RawData/{dataset}/document/queries.dev.tsv'
    qID_l = []
    ...
    if dataset == 'lotte' or dataset == 'msmacro':

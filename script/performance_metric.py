...
def load_groundtruth(username: str, dataset: str, topk: int):
    ...
    rawdata_path = f'/home/{username}/Dataset/vector-set-similarity-search/RawData/{dataset}'
...
def count_accuracy(username: str, dataset: str, topk: int,
    ...
    answer_dir = f'/home/{username}/Dataset/vector-set-similarity-search/Result/answer'
